...
if curIndex == 0 then
setArray({'selectedOp.visible', 'selectedOp2.visible', 'selectedOp3.visible', 'selectedOp4.visible'}, {true, false, false, false})
setArray({'selected.visible', 'selected2.visible', 'selected3.visible', 'selected4.visible'}, {true, false, false, false})
setArray({'noSelected.visible', 'noSelected2.visible', 'noSelected3.visible', 'noSelected4.visible'}, {false, true, true, true})
end
if curIndex == 1 then
setArray({'selectedOp.visible', 'selectedOp2.visible', 'selectedOp3.visible', 'selectedOp4.visible'}, {false, true, false, false})
setArray({'selected.visible', 'selected2.visible', 'selected3.visible', 'selected4.visible'}, {false, true, false, false})
setArray({'noSelected.visible', 'noSelected2.visible', 'noSelected3.visible', 'noSelected4.visible'}, {true, false, true, true})
end
if curIndex == 2 then
setArray({'selectedOp.visible', 'selectedOp2.visible', 'selectedOp3.visible', 'selectedOp4.visible'}, {false, false, false, true})
setArray({'selected.visible', 'selected2.visible', 'selected3.visible', 'selected4.visible'}, {false, false, false, true})
setArray({'noSelected.visible', 'noSelected2.visible', 'noSelected3.visible', 'noSelected4.visible'}, {true, true, true, false})
end
