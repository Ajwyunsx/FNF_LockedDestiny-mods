...
function onEventSet()
    ...
    stepEvent(1860, function()
        ...
        noteTweenY('1Y', 4, 300, 0.3, 'ExpoIn')

        noteTweenX('2', 5, 610, 0.3, 'ExpoIn')
        noteTweenY('2Y', 5, 400, 0.3, 'ExpoIn')

        noteTweenX('3', 6, 610, 0.3, 'ExpoIn')
        noteTweenY('3Y', 6, 200, 0.3, 'ExpoIn')

        noteTweenX('4', 7, 710, 0.3, 'ExpoIn')
        noteTweenY('4Y', 7, 300, 0.3, 'ExpoIn')

        noteTweenDirection('BFLEFT', 4, 180, 0.3, 'ExpoIn')
        noteTweenDirection('BFDOWN', 5, 90, 0.3, 'ExpoIn')
        noteTweenDirection('BFUP', 6, 270, 0.3, 'ExpoIn')
        noteTweenDirection('BFRIGHT', 7, 0, 0.3, 'ExpoIn')
